...
function App() {
  ...
  if (currentCar) {
    return (
      <div class="container">
        ...
        {!showPriceInput && <button onClick={() => setShowPriceInput(true)}>Change Price</button>}
        {showPriceInput && (
          <div>
            <input
              type="number"
            ...
            />
            <button onClick={() => handlePriceChange(currentCar.id)}>Update Price</button>
            <button onClick={() => setShowPriceInput(false)}>Done</button>
          </div>
        )}
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6" >
            ...
            <form>
              <div class="form-group">
                <input class="form-control" type="text" placeholder="Name" value={userName} onChange={(event) => setUserName(event.target.value)} />
              </div>
              <div class="form-group">
                <input class="form-control" type="email" placeholder="Email" value={userEmail} onChange={(event) => setUserEmail(event.target.value)} />
              </div>
              <div class="form-group">
                <input class="form-control" type="text" placeholder="Credit Card Number" value={creditCardNumber} onChange={(event) => setCreditCardNumber(event.target.value)} />
              </div>
              <div class="form-group">
                <input class="form-control" type="text" placeholder="Expiry Date (MM/YY)" value={creditCardExpiry} onChange={(event) => setCreditCardExpiry(event.target.value)} />
              </div>
              <div class="form-group">
                <input class="form-control" type="text" placeholder="CVV" value={creditCardCVV} onChange={(event) => setCreditCardCVV(event.target.value)} />
              </div>
              <div class="form-group">
                <input class="form-control" type="text" placeholder="Street" value={userAddress.street} onChange={(event) => setUserAddress({ ...userAddress, street: event.target.value })} />
              </div>
              <div class="form-group">
                <input class="form-control" type="text" placeholder="City" value={userAddress.city} onChange={(event) => setUserAddress({ ...userAddress, city: event.target.value })} />
              </div>
              <div class="form-group">
                <input class="form-control" type="text" placeholder="Country" value={userAddress.country} onChange={(event) => setUserAddress({ ...userAddress, country: event.target.value })} />
              </div>
              <div class="form-group">
                <input class="form-control" type="text" placeholder="state" value={userAddress.state} onChange={(event) => setUserAddress({ ...userAddress, state: event.target.value })} />
              </div>
              <div class="form-group">
                <input class="form-control" type="text" placeholder="Postal Code" value={userAddress.postalCode} onChange={(event) => setUserAddress({ ...userAddress, postalCode: event.target.value })} />
              </div>
              <button class="btn btn-primary" onClick={() => handleCheckout(rentCarId)}>Checkout</button>
            </form>
          </div>
        </div>
      </div>
  ...
  return (
    <div class="container">
      <h1 class="mt-4">Welcome to Ames Car Rental Site!</h1>
      <img src="http://127.0.0.1:4000/images/cars.png" alt="Your Image Description" className="img-fluid w-100" />

      <p class="lead text-muted">Experience the freedom of the open road with our rental cars. Whether you
